...
| tagRenderer        | Multi-value Tag renderer | ({ value, text, key, readOnly, invalid, disabled, onClose, className, inputBoxIsFocus, record, field }: TagRendererProps) => ReactNode |  | 1.6.2 |
